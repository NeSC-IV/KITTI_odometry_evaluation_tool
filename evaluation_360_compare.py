...
class kittiOdomEval():
    ...
    def eval(self, toCameraCoord):
        ...
        for seq in self.eval_seqs_sage:
            ...
            poses_result2 = self.loadPoses(pred_file_name2, toCameraCoord=False, format = self.pose_format, seq_num = seq_num)
            poses_result3 = self.loadPoses(pred_file_name3, toCameraCoord=False, format = self.pose_format, seq_num = seq_num)
